...
export const asyncRouterMap = [
  { path: '',
    ...
    children: [
      ...
      { path: 'cases', component: () => import('@/views/web/CasesNew') },
      { path: 'cases/channel/:id', component: () => import('@/views/web/CasesNew') },
      { path: 'casesInfo/:id', component: () => import('@/views/web/CasesNew/info') },
      ...
      { path: 'navItemInfo/:id', component: () => import('@/views/web/NavItemInfo') },
